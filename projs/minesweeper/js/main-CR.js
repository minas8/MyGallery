'use strict'
//@CR: Hi Mina, you made a great project, I'll put comments with '@CR' at the beginning,
...
function buildBoard() {
    ...
    //@CR: remove unnecessary comments on final submission
...
function craeteBoard(boradSize) { //@CR: createBoard*
    // Create the Matrix
    var board = [];
    ...
    if (gGame.isOn) {
        ...
        if (gGame.isHintClicked) {
            ...
            if (isRightClick) {
                ...
                //@CR: we could use mouse-event onclick and check whether it's rightclick,
                //if so event.preventDefault, without listeners and cancelling the context menu on the whole app.
